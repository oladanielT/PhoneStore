export const store = {
  name: "God's best tech Store Ife",
  shortName: "God's best tech",
...
export function whatsappLink(message: string, whatsappNumber = store.whatsappNumber) {
